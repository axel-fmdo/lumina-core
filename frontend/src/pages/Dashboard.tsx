...
import { 
  DollarSign, Box, CheckCircle2, AlertOctagon, Activity, 
  ArrowRight, User, TrendingUp 
} from "lucide-react";
...
interface DashboardData {
  ...
  recent_activity: any[]; // Usamos el tipo AssetHistory que ya tienes
}
...
export const DashboardView = () => {
  ...
  // Preparar datos para gráfica de dona (Estado)
  const statusData = [
