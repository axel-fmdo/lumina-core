...
export const UserModal = ({ isOpen, onClose, onSuccess, userToEdit }: UserModalProps) => {
    ...
    const { register, handleSubmit, reset, formState: { errors, isValid } } = useForm<UserFormData>({
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4">
                    ...
                    <div className="pt-4 flex justify-end gap-3">
                        ...
                        <button 
                            ...
                            className="px-6 py-2 bg-lumina-primary hover:bg-indigo-600 text-white rounded-lg text-sm font-medium flex items-center gap-2 transition-all shadow-lg shadow-lumina-primary/20 disabled:opacity-50"
                        >
